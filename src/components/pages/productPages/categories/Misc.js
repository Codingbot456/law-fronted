...
import misc1 from '../../../assets/images/miscalenous-1.jpg';
...
const Misc = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:4000/api/products/category/6'); // Adjust endpoint URL as needed
